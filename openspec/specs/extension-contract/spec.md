# extension-contract Specification

## Purpose

Defines the generic contract for optional extensions in the generated projects: how extensions are declared in starter metadata, selected in render input, resolved and checked for compatibility, composed deterministically, contribute structured mutations, and are validated — while keeping the neutral starter free of any concrete extension and independent of a repository-local extension directory.
